...
export default function ForgotPassword() {
  return(
    <div className="bg-gradient-to-b from-[#0f0f0f] to-[#111827] min-h-screen flex flex-col gap-[40px] items-center justify-center">
      ...
      <div className="flex flex-col gap-4 w-full max-w-[400px]">
        ...
        <Link href="/page-principal" className="bg-blue-500 text-white p-4 rounded-md w-full max-w-[400px]">
          <span className="flex items-center justify-center text-[#0f0f0f]">Enviar</span>
        </Link> 

        <span className="text-zinc-400 text-sm">
          Lembrou sua senha? <Link href="/" className="text-blue-500">Faça login</Link>
        </span>
